      ...
      <div className="container py-4">
        ...
        <div className="text-center mb-4">
          ...
          <p style={{
            ...
            <FontAwesomeIcon icon={faShieldAlt} /> Your information is safe and secure
          </p>
        </div>
            ...
            <div className="col-lg-8">
              ...
              <div style={{
                ...
                <h3 style={{
                  ...
                  <FontAwesomeIcon icon={faTruck} style={{ color: 'var(--sand-600)' }} />
                  Shipping Address
                </h3>
              ...
              <div style={{
                ...
                <h3 style={{
                  ...
                  <FontAwesomeIcon icon={faCreditCard} style={{ color: 'var(--sand-600)' }} />
                  Payment Method
                </h3>
                ...
                <div className="d-flex gap-3 mb-3 flex-wrap">
                  ...
                  <button
                    ...
                    style={{
                      padding: '1rem 1.5rem',
                      border: `2px solid ${paymentMethod === 'cod' ? 'var(--sand-600)' : 'var(--sand-400)'}`,
                      borderRadius: '10px',
                      backgroundColor: paymentMethod === 'cod' ? 'var(--sand-100)' : 'white',
                      cursor: 'pointer',
                      transition: 'all 0.3s ease',
                      flex: 1,
                      minWidth: '150px'
              ...
              <div style={{
                ...
                <div style={{ marginBottom: '1.5rem' }}>
                  ...
                  <div style={{
                    ...
                    <span>Shipping</span>
                    <span style={{ color: shipping === 0 ? '#28a745' : 'var(--sand-800)' }}>
                  ...
                  <div style={{
                    borderTop: '2px solid var(--sand-400)',
                    paddingTop: '0.8rem',
                    marginTop: '0.8rem'
                  }}>
                    <div style={{

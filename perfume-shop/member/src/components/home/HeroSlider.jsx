...
import { fetchBanners } from '../../redux/apis/BannerApi';

export default function HeroSlider() {
  const dispatch = useDispatch();
  const { banners, loading } = useSelector(state => state.BannerSlice);
  ...
  }, [currentSlide, banners.length, totalSlides]);
    ...
    return (
      ...
      >
        <div className="text-center">
          ...
          <p className="mt-3" style={{ color: 'var(--sand-700)' }}>Loading banners...</p>
        </div>
      </div>
    );
  }
